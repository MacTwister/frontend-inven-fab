...
export const Navbar = ({ isCartAccessible, cartItems, toggleCartModal }) => {
    return (
        ...
        <nav className="bg-gray-900 dark:bg-gray-900 fixed w-full z-10 top-0 start-0 border-b border-gray-600 dark:border-gray-600">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <span className="self-center text-2xl font-semibold whitespace-nowrap text-white dark:text-white">FAB24 Inventory</span>
                </a>
